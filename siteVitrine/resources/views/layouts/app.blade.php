        ...
        <nav class="navbar navbar-expand-md navbar-light bg-success shadow-sm">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}">
                    Vitrine
                    <img src='img/VITRINEAUTRE.png' height="50px" width="50px"/>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#">Vitrine</a>
                          </li>
                          <li class="nav-item">
...
<!--Footer-->
<footer class="pt-4 my-md-5 pt-md-5 border-top bg-success text-white footerst">
    <div class="row">
      <div class="col-12 col-md">
        <img class="mb-2" src="img/VITRINEAUTRE.png" alt="" width="50" height="50">
